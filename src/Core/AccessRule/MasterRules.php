...
class MasterRules extends BaseAccessRules
{
    ...
    public const DIGITAL_LINK_MASTER_SECTION = 100;
    public const DIGITAL_LINK_MASTER_ALLOWED_LOCATIONS = 101;
    public const DIGITAL_LINK_MASTER_ALLOWED_LINKS = 102;
    public const DIGITAL_LINK_MASTER_ALLOW_SEARCH = 103;
    public const DIGITAL_LINK_MASTER_ALLOW_MANAGE_TASKS = 104;
    public const DIGITAL_LINK_MASTER_ALLOW_FILTER = 105;
    public const DIGITAL_LINK_MASTER_MAX_HOUSE = 106;
    public const DIGITAL_LINK_MASTER_MAX_HOUSE_PERCENT = 107;
