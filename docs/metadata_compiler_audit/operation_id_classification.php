...
return [
    ...
    /* ---------------- route-only: ADD (26) — real endpoints missing from the spec ---------------- */
    ...
    'GET:/api/import/tickets'                  => ['resolution' => 'add', 'reason' => 'integration/import endpoint missing from spec; confirm public-vs-internal'],
    ...
    'POST:/api/exchange-1c/employees'          => ['resolution' => 'add', 'reason' => '1C integration endpoint missing from spec; confirm public-vs-internal before exposing to LK client'],
    'POST:/api/import/access-rules/bulk'       => ['resolution' => 'add', 'reason' => 'bulk import endpoint missing from spec; confirm public-vs-internal'],
    ...
    'POST:/api/users/duplicate'                => ['resolution' => 'add', 'reason' => 'real admin action (deleteDuplicatesUsers) missing from spec; confirm public-vs-internal'],
